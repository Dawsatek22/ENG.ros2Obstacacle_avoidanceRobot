...
#this is subscriber node  to control a robot with dc motors and hcsr04 distance sensor and l298N in ROS2 (Iron_Irwini) Framework.

#now it  imports the ROS2 library
import rclpy
from rclpy.node import Node

from std_msgs.msg import String                   # import strings.
from time import sleep # import sleep for time.
...
import board
import adafruit_hcsr04 # the sensor library (if you dont have it installed or need more info here is the link https://docs.circuitpython.org/projects/hcsr04/en/latest/index.html )
sonar = adafruit_hcsr04.HCSR04(trigger_pin=board.D17, echo_pin=board.D4) # setting up the sensor
